  ...
  return (
    <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50">
      <div className="bg-white/90 backdrop-blur-md border border-gray-200 rounded-full shadow-2xl px-6 py-3 flex items-center gap-6">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-4">
            ...
            >
              ...
              {/* Dropdown Menu */}
              <div
                className={`absolute top-full left-0 w-48 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden transition-all duration-200 origin-top-left ${
                  isLabsOpen
              ...
              >
                <div className="p-1">
                  <Link
                    href="/labs/genetics"
                    className="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors font-bangers tracking-wide"
                  >
            ...
            <Link
              href="/market"
              className="flex items-center gap-1 text-gray-600 hover:text-gray-900 font-medium transition-colors font-bangers tracking-wide"
            >
        ...
        {/* Zone de connexion : UN SEUL bouton wallet Sui stylé */}
        <div className="flex items-center gap-4 pl-4 border-l border-gray-200">
          <div className="rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 p-[2px] shadow-md shadow-cyan-500/40">
            <div className="rounded-full bg-white px-4 py-1 [&_button]:!rounded-full [&_button]:!px-6">
              <ConnectButton />
            </div>
          </div>
        </div>
